...
#================================================================================================================================
    ...
    #Set x- and y lim
    plt.xlim([0,simulationArea])
    plt.ylim([0,simulationArea])

    filename = 'electricFieldAndParticleAtTime' + plotindex
    plt.xlabel("X")
    plt.ylabel("Y")
    plt.xticks(np.arange(0,simulationArea, sizeOfOneBox))#size of one box
    plt.yticks(np.arange(0,simulationArea, sizeOfOneBox))
